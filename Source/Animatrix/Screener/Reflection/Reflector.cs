...
namespace Animatrix.Screener.Reflection
{
    class Reflector :Control,IScreener 
    {
        ...
        private Bitmap _imageToPaint;
        public Bitmap imageToPaint { get { return _imageToPaint; }
            set {
                this.update();
                _imageToPaint =value ;
            }
    ...
    //class Reflector :ControlScreener 
    //{
    //    public Reflector(Control host)
    //        : base(host)
    //    { }
    ...
    //        base.coverTheHost();
    //        Region rg = new Region();
    //        rg.Exclude(new Rectangle(HostRelativeLocation, getHostSize()));
    //        this.Region = rg;
    //        rg.Dispose();
    //        rg = null;
    //    }
